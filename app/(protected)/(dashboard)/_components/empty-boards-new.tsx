      ...
      <div className="max-w-lg w-full text-center">
        ...
        <div className="mb-8 flex justify-center">
          <div className="relative w-40 h-40">
            ...
            <div className="absolute inset-0 rounded-3xl bg-white border-2 border-dashed border-[#DDDDDD] flex items-center justify-center">
              <Sparkles className="h-12 w-12 text-[#20C5A8]" strokeWidth={1.2} />
            </div>
          </div>
        </div>
        ...
        <p className="mt-3 text-[#696969] leading-relaxed max-w-sm mx-auto">
          Start with a blank board or pick a template to jump right in.
        </p>
